      ...
      <PageShell>
        <div className="mx-auto max-w-md py-16 text-center">
          ...
          <a
            ...
            className="mt-6 inline-flex items-center gap-2 rounded-full border-2 border-[#72cfc0] bg-mint px-5 py-3 text-sm font-extrabold text-ink"
          >
            <img
      ...
      <div className="mx-auto mt-5 max-w-2xl rounded-3xl border border-line bg-card p-6 text-center sm:p-9">
        ...
        >
          ...
          <a
            ...
            rel="noopener noreferrer"
            onClick={handleSend}
            className="mt-4 flex items-center justify-center gap-2 rounded-full bg-[#25D366] px-5 py-3.5 text-sm font-extrabold text-white shadow-[0_8px_18px_rgba(37,211,102,.35)] transition hover:-translate-y-0.5"
          >
            <img
              src="/icons/whatsapp.svg"
              alt=""
